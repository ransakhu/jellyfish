...
//                                                .font(.title2)
//                                                .foregroundColor(newTaskName.trimmingCharacters(in: .whitespaces).isEmpty ? .gray : Color(red: 0.6, green: 0.9, blue: 0.6))
//                                        }
...
//                    Button {
//                        withAnimation {
//                            isAddingTask = true  // or isAddingList = true in HomeView
//                        }
//                        DispatchQueue.main.asyncAfter(deadline: .now() + 0.1) {
//                            newTaskFocused = true  // or newListFocused = true in HomeView
//                        }
//                    } label: {
//                        ZStack {
//                            Circle()
...
//MARK: inline adding and reminder
import SwiftUI
