...
//                    ScrollView {
//                        LazyVStack(spacing: 16) {
//                            // New list input box (appears when adding)
//                            if isAddingList {
//                                HStack(spacing: 12) {
...
//                                                    viewModel.addTaskList(name: newListName)
//                                                    newListName = ""
//                                                    isAddingList = false
//                                                }
//                                            }
...
//                                            .font(.title2)
//                                            .foregroundColor(newListName.trimmingCharacters(in: .whitespaces).isEmpty ? .gray : Color(red: 0.6, green: 0.9, blue: 0.6))
//                                    }
...
//                            }
//                            
//                            if sortedLists.isEmpty && !isAddingList {
//                                VStack(spacing: 12) {
//                                    Image(systemName: showingArchive ? "archivebox" : "list.bullet")
//                                        .font(.system(size: 60))
//                                        .foregroundColor(.gray.opacity(0.5))
...
//                    
//                    ZStack(alignment: .bottom) {
//                        // Blur background - more iOS style
//                        Rectangle()
