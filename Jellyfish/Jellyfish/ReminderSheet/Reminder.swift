...
struct Reminder: View {
    ...
    var body: some View {
        ZStack {
            ...
            Button("Add Task Details Raghad") {
...
struct AddReminderModalView: View {
    ...
    var repeatText: String {
        repeatCount == 1 ? "Never" : "\(repeatCount) times daily"
    }
                ...
                VStack(spacing: 0) {
                    ...
                    VStack(spacing: 0) {
                        Button(action: {
                            ...
                            optionRow(title: "Repeat", trailing: repeatText)
                        }
                        ...
                        Button(action: {
                            ...
                            optionRow(title: "Sound", trailing: selectedSound)
                        }
                        .buttonStyle(PlainButtonStyle())
                        ...
                        HStack {
                            ...
                            Spacer()
                            TextField("Reminder", text: $labelText)
    ...
    var body: some View {
        NavigationView {
            ZStack {
                ...
                VStack {
                    Picker("Repeat Count", selection: $tempRepeatCount) {
                        Text("Never").tag(1)
                        ForEach(2...8, id: \.self) { count in
                            Text("\(count) times daily").tag(count)
                        }
                    }
                    .pickerStyle(.wheel)
                    .padding()
